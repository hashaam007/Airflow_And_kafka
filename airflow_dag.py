...
default_args = {
'owner': 'Hashaam Rajpoot',
'start_date': days_ago(0),
'email': ['hashaammushtaq@gmail.com'],
...
bash_command = 'paste csv_data.csv tsv_data.csv fixed_wisth_data.csv > extracted_data.csv',
dag = dag,
)
...
unzip_data >> extract_data_from_csv >> extract_data_from_tsv >> extract_data_from_fixed_width_file >> consolidate_data >> transform_data
